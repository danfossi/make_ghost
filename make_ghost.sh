...
#                 gdisk, ntfs-3g, lvm, awk, partclone, hfsutils
#
...
function ghost {
                ...
                if [ $? -eq 0 ] ; then
                        ...
                        partimage -B Description*=Continue save /dev/${D_PART_TO_SAVE} ./${D_PART_TO_SAVE}
                        if [ $? -eq 0 ] ; then
                                echo -e "Done!\n"
                        else
                                echo -e "Failed!\n"
...
# Indentify Partition(s)
        case "${dparttypearray[$i]}" in
            ...
            ;;
                ...
                2700)
                        # Windows RE (Windows Recovery)
                        echo $D_FULL_PATH "is Windows Recovery"
                        ghost $D_FULL_PATH
                        # action
            ;;
            ...
            ;;
                ...
                A501)
                        # FreeBSD boot
                        echo $D_FULL_PATH "is FreeBSD boot"
                        ghost $D_FULL_PATH
                        # action
                        ;;
                ...
                A503)
                        # FreeBSD UFS
                        echo $D_FULL_PATH "is FreeBSD UFS"
                        ghost $D_FULL_PATH
                        # action
                        ;;
